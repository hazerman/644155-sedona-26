...
* Студент: [Иван Одинцов](https://up.htmlacademy.ru/htmlcss/26/user/644155).
* Наставник: Кекс.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/644155-sedona-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
